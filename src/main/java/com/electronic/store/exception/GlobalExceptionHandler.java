...
public class GlobalExceptionHandler {
	...
	//  private Logger logger=LoggerFacory.sl
	//handle ResourceNot Found exception
	...
	public ResponseEntity<ApiResponseMessage> handleBadApiRequest(BadApiException ex){
